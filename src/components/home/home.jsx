        ...
        <div>
          {language ? (
            <p>
              ...
              meeting deadlines are essential, so I thrive working in a team and I'm used
              to working under pressure of time. I personally enjoy learning new things
              and working hard to solve logical problems. I see every challenge as an
              opportunity to grow.
            ...
            <p>
              ...
              cumplimiento de plazos, por lo que prospero trabajando en equipo y estoy
              acostumbrado a trabajar bajo la presión del tiempo. Personalmente disfruto
              de aprender cosas nuevas y trabajar duro para resolver problemas lógicos.
              Veo cada desafío como una oportunidad para crecer.
              <br /> <br />
        ...
        <div id="contact-container">
          ...
          {language ? (
            <p>
              ...
              position, don't hesitate to contact me through any of these options!
            </p>
          ) : (
            <p>
